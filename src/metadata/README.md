 ...
 * [ubo.yml](ubo.yml)
     * Determines how your purl.obolibrary.org/obo/ubo/ redirects will be handled
     ...
     * Paste in the contents of [ubo.yml](ubo.yml)
 ...
 * [ubo.md](ubo.md)
     ...
     * Paste in the contents of [ubo.md](ubo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
